...
- 官方硬约束：摘要原则上不超过 1 页；纸质版第 1 页承诺书、第 2 页编号专用页、第 3 页摘要专用页、第 4 页起正文；不要目录；正文不超过 30 页；正文后附录；摘要页起连续编页。电子版首页必须是摘要专用页，删除承诺书和编号专用页；建议单个 PDF 且不超过 20 MB。支撑材料压缩为一个 RAR/ZIP，不超过 20 MB，并在论文附录列清单。摘要、正文、附录和支撑材料全部匿名。
- 质量目标而非官方规则：默认约 15000 字词单位、约 20 页、5 个公式、8 幅图、3 个表；公式、图和表可根据题目增加或减少，不能因数量低于默认值就当作官方违规。
