...
`1.1.0` 在 GPT 5.6 Sol 全面检查和完善的 `1.0.0` 基线上，新增模板驱动的 LaTeX/PDF 与 DOCX 双格式论文交付、阶段内独立 Subagent 质检、Nature/SCI 科学绘图闭环，以及源码—产物哈希绑定和完整发布门禁。详细内容见 [CHANGELOG.md](CHANGELOG.md)。
